...
/**
 * Factory class that creates new {@link CommonCrawlFormat CommonCrawlFormat} objects (a.k.a. formatter) that map crawled files to CommonCrawl format.
 *
 */
public class CommonCrawlFormatFactory {
	
	/**
	 * Returns a new instance of a {@link CommonCrawlFormat CommonCrawlFormat} object specifying the type of formatter.
	 ...
	 * @return the new {@link CommonCrawlFormat CommonCrawlFormat} object.
